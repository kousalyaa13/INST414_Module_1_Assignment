...
# primaryid may appear multiple times (one per reaction), and we need to verify that demographic fields like sex don’t vary across rows for the same report.
```{python}
